...
class AreaSelector:
    def __init__(self):
        ...
        self.canvas.create_text(self.root.winfo_screenwidth() / 2, self.root.winfo_screenheight() / 2, text="Click and drag to select area", font=("Arial", 16, "bold"))
    ...
    def on_button_press(self, event):
        ...
        self.rect = self.canvas.create_rectangle(self.start_pos[0], self.start_pos[1], 1, 1, outline="red", width=2, dash=(3, 20))
    ...
    def on_button_release(self, event):
        ...
        self.canvas.create_text(x1, y1, text="Press ESCAPE or RETURN to confirm selection.", font=("Arial", 12, "bold"), anchor="sw")
